...
// height = 실제 3D 기하 높이 (bottom=0 기준, 단위: three.js units)
// BUN: 실린더(0.22) + 반구(0.95) = 1.17 → 1.15 로 정의
// PATTY: 실린더 그대로
// VEGGIE/TOPPING: 각 기하 높이 그대로
// HAMSTER: HamsterTopping에서 bbox 정규화 → 1.5 고정

export const INGREDIENTS = [
  // ── 빵 ──────────────────────────────────────────────────────────────────────
  {
    id: 'bun_bottom', name: '빵 아래', emoji: '🍞',
    category: 'base', height: 1.15, color: '#D4936A', meshType: 'bun_bottom',
    cardBg: '#FFF3E0', cardBorder: '#FFCC80',
  },
  {
    id: 'bun_top', name: '빵 위', emoji: '🍞',
    category: 'base', height: 1.15, color: '#C8834A', meshType: 'bun_top',
    cardBg: '#FFF3E0', cardBorder: '#FFCC80',
  },
  ...
  // ── 패티 ────────────────────────────────────────────────────────────────────
  {
    ...
    category: 'patty', height: 0.26, color: '#4A1C00', meshType: 'patty',
    cardBg: '#FCE4EC', cardBorder: '#F48FB1',
  },
  {
    id: 'chicken', name: '치킨 패티', emoji: '🍗',
    category: 'patty', height: 0.22, color: '#C49A3A', meshType: 'patty_chicken',
  ...
  // ── 야채 ────────────────────────────────────────────────────────────────────
  {
    ...
    category: 'veggie', height: 0.08, color: '#4CAF50', meshType: 'lettuce',
    cardBg: '#E8F5E9', cardBorder: '#A5D6A7',
  },
  {
    id: 'tomato', name: '토마토', emoji: '🍅',
    category: 'veggie', height: 0.11, color: '#E53935', meshType: 'tomato',
    cardBg: '#FFEBEE', cardBorder: '#EF9A9A',
  },
  {
    id: 'onion', name: '양파링', emoji: '🧅',
    category: 'veggie', height: 0.12, color: '#F8BBD9', meshType: 'onion',
    cardBg: '#FCE4EC', cardBorder: '#F48FB1',
  },
  {
    id: 'pickle', name: '피클', emoji: '🥒',
    category: 'veggie', height: 0.07, color: '#388E3C', meshType: 'pickle',
  ...
  // ── 토핑 ────────────────────────────────────────────────────────────────────
  {
    ...
    category: 'topping', height: 0.07, color: '#FFC107', meshType: 'cheese',
    cardBg: '#FFFDE7', cardBorder: '#FFE082',
  },
  {
    id: 'bacon', name: '베이컨', emoji: '🥓',
    category: 'topping', height: 0.10, color: '#EF9A9A', meshType: 'bacon',
    cardBg: '#FCE4EC', cardBorder: '#F48FB1',
  },
  {
    id: 'egg', name: '계란프라이', emoji: '🍳',
    category: 'topping', height: 0.42, color: '#FFFDE7', meshType: 'egg',
    cardBg: '#FFFDE7', cardBorder: '#FFF176',
  },

  // ── 🌟 햄스터 (bounding box 정규화 → 1.5 단위로 고정) ─────────────────────
  {
    id: 'golden_ham', name: '골든 햄스터', emoji: '🐹',
    category: 'hamster', height: 1.5, color: '#FFB347', meshType: 'hamster',
    modelPath: assetPath('/models/golden_ham.glb'),
    cardBg: '#FFFBEA', cardBorder: '#FFD700', isHamster: true,
  },
  {
    id: 'jungarian_ham', name: '정가리안', emoji: '🐹',
    category: 'hamster', height: 1.5, color: '#A8D8A8', meshType: 'hamster',
    modelPath: assetPath('/models/jungarian_ham.glb'),
    cardBg: '#F0FFF4', cardBorder: '#FFD700', isHamster: true,
  },
  {
    id: 'pearl_ham', name: '펄 햄스터', emoji: '🐹',
    category: 'hamster', height: 1.5, color: '#F4ACB7', meshType: 'hamster',
  ...
  },
  {
    ...
    category: 'hamster', height: 1.5, color: '#B39DDB', meshType: 'hamster',
